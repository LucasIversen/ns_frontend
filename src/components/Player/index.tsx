...
const Player = () => {
  ...
  const player = roster?.find(
    (player) => player.name.split(" ").join("_") === name
  );
      ...
      {player ? (
        <div className="player">
          <div className="player-image">
            <img
              src={
                "https://firebasestorage.googleapis.com/v0/b/nsbackend-3fd2c.appspot.com/o/00377%20-%20Nordic%20Storm%20Combine-12.jpg?alt=media&token=6c8d4f0f-3560-4fdd-b929-ccaedce87f55"
              }
              alt={player.name}
            />
          </div>
